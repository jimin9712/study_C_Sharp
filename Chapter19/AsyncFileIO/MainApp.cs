...
namespace AsyncFileIO
{
    class MainApp
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.ReadLine();
            //FileInfo sourceInfo = new FileInfo(args[0]);
            //FileInfo destInfo = new FileInfo(args[1]);
            //Console.WriteLine($"Source file size: {sourceInfo.Length} bytes");
            //Console.WriteLine($"Copied file size: {destInfo.Length} bytes");
